...
The domain documentation files are written in Markdown. Their file names are:

- **CONTEXT file**: `CONTEXT.md`
- **CONTEXT-MAP file**: `CONTEXT-MAP.md`
- **ADR**: `docs/adr/*.md` and, in a multi-context repo, `src/<context>/docs/adr/*.md`.
...
Note: Documents can be in a different file format like AsciiDoc or reStructuredText with different file name extensions like adoc or rst.
