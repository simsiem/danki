...
Translate the above Markdown example to the right file format of the CONTEXT file, if it is not Markdown.
...
Translate the above Markdown example to the right file format of the CONTEXT-MAP file, if it is not Markdown.
