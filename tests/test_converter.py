...
def _run_conversion(body, expected_csv, book):
    expected_head_line = "Headword,FullFormDisplay,FullFormNormalized,Meanings,PartOfSpeech,NotesForeign,NotesNative,MnemonicHint,PronunciationText,AudioUrl,ReferenceBook,ReferenceSection,Exercise1Front,Exercise1Back,Exercise2Front,Exercise2Back,Exercise3Front,Exercise3Back,Tags"
...
# Headword,FullFormDisplay,FullFormNormalized,Meanings,PartOfSpeech,NotesForeign,NotesNative,MnemonicHint,PronunciationText,AudioUrl,ReferenceBook,ReferenceSection,Exercise1Front,Exercise1Back,Exercise2Front,Exercise2Back,Exercise3Front,Exercise3Back,Tags
@pytest.mark.parametrize(
    ("body", "expected_csv_row"),
    [
        (
            "<p>auxilium    die Hilfe15</p>",
            #    1        2        3        4            11   12
            "auxilium,auxilium,auxilium,die Hilfe,,,,,,,book1,15,,,,,,,",
        ),
        (
            "<p>ā / ab Präp. m. Abl.    von, von ... her16</p>",
            'a / ab,ā / ab,a / ab,"von, von ... her",Präposition,Präp. m. Abl.,,,,,book1,16,,,,,,,',
        ),
        (
            "<p>dum  Subj.    während, solange, bis19</p>",
            'dum,dum,dum,"während, solange, bis",Subjunktion,Subj.,,,,,book1,19,,,,,,,',
        ),
        (
            "<p>iuvenis, iuvenis m    der junge Mann; Adj. jung<span>32</span></p>",
            'iuvenis,"iuvenis, iuvenis","iuvenis, iuvenis",der junge Mann; Adj. jung,Nomen,m,,,,,book1,32,,,,,,,',
        ),
        (
            "<p><span>līberī, līberōrum</span> m Pl.    die Kinder<span>26</span></p>",
            'liberi,"līberī, līberōrum","liberi, liberorum",die Kinder,Nomen,m Pl.,,,,,book1,26,,,,,,,',
        ),
        (
            "<p><span>ostendere, ostendō, ostendī</span>    zeigen, erklären<span>16. 28</span></p>",
            'ostendere,"ostendere, ostendō, ostendī","ostendere, ostendo, ostendi","zeigen, erklären",,,,,,,book1,16;28,,,,,,,',
        ),
        (
            ...
            "auxilium,auxilium,auxilium,die Hilfe,,,,,,,book1,15,,,,,,,Top500",
        ),
        (
            ...
            'a / ab,ā / ab,a / ab,"von, von ... her",Präposition,Präp. m. Abl.,,,,,book1,16,,,,,,,Top500',
        ),
        (
        ...
        (
            ...
            'ostendere,"ostendere, ostendō, ostendī","ostendere, ostendo, ostendi","zeigen, erklären",,,,,,,book1,16;28,,,,,,,Top500',
        ),
        (
        ...
        (
            ...
            'comes,"comes, comitis","comes, comitis","der (die) Begleiter(in), der Gefährte, die Gefährtin",Nomen,m/f,,,,,book1,32,,,,,,,',
        ),
    ],
)
...
def test_duplicate_mismatch_logs_and_keep_first():
    body = "<p>ācer   energisch 32</p><p>ācer   anders 32</p>"
    expected_csv = "acer,ācer,acer,energisch,,,,,,,book1,32,,,,,,,"
